...
![image](https://www.php.net/images/php.gif)On apprend dans cet [article de Nexen](http://www.nexen.net/actualites/php/php_4.4.4_et_5.2.0_en_preparation.php) que les prochaines version PHP   de la branche 4.x et 5.x vont bientôt passer les tests de qualité précedent la release.
