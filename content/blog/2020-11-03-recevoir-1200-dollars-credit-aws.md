...
4. Puis renseignez tout le formulaire (n’hésitez pas à passer votre souris sur les ? pour savoir quoi mettre).
  <img src="/img/flash-briefing-form.png" alt="Flash Briefing formulaire">
...
7. Si aucune erreur n’est trouvée, vous pouvez passer sur le sous menu “_Submission_” à gauche.
  <img src="/img/skill-ready-for-submission.png" alt="Skill ready to be submitted">
...
<img src="/img/mail-aws-credit.png" alt="Email d'AWS indiquant le gain de crédit">
